  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="<?= base_url('UsuarioController/adicionar') ?>" method="post" class="form">
        ...
        <!--telefone-->
        <div class="field">
          <img src="https://cdn1.iconfinder.com/data/icons/modern-universal/32/icon-03-256.png" alt="telefone"
            height="25" width="25">
          <input autocomplete="off" placeholder="Telefone" class="input-field" name="TELEFONE" id="TELEFONE"
            type="text">
        </div>
        <!--descricao-->
        <div class="field">
          <img src="https://cdn0.iconfinder.com/data/icons/free-daily-icon-set/512/Task-256.png" alt="desc" height="25"
            width="25">
          <input autocomplete="off" placeholder="Descrição" class="input-field" name="DESCRICAO_USER"
            id="DESCRICAO_USER" type="text">
        </div>
        <!--senha-->
        <div class="field">
