    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">Meu perfil</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#experience">Minhas publicações</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#config">Configurações</a></li>
        ...
        <div class="container-fluid">
          ...
          <input class="" type="search" placeholder="Pesquisar" aria-label="Search">
            <button class="btnPink" type="submit">
