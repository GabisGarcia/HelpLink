...
<center>
  ...
  <form action="<?=base_url()?>/PostController/editar" method=post>
      ...
      <div class="input-containerTeste">
        ...
        <input class="inputPost" type="text" id="TITULO" name="TITULO" value="<?= $post->TITULO ?>" required>
        <label class="labelPost" for="CONTATO">Contato:</label>
        <input class="inputPost" type="text" id="CONTATO" name="CONTATO" value="<?= $post->CONTATO ?>" required>
      </div>
      <div class="input-containerTeste">
        ...
        <input class="inputPost" type="text" id="DOACAO" name="DOACAO" value="<?= $post->DOACAO ?>" required>
      </div>
      <br>
      ...
      <textarea id="mensagem" name="DESCRICAO" required><?= $post->DESCRICAO ?></textarea>
